...
SINGLE_SITE_COUNTRIES_ADULT = ["Spain", "Singapore"]
SINGLE_SITE_COUNTRIES_PEDIATRIC = ["Spain", "Singapore", "UK"]
MERGED_SINGLE_SITE_COUNTRIES_ADULT_NAME = " + ".join(SINGLE_SITE_COUNTRIES_ADULT)
MERGED_SINGLE_SITE_COUNTRIES_PEDIATRIC_NAME = " + ".join(SINGLE_SITE_COUNTRIES_PEDIATRIC)